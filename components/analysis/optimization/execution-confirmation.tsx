        ...
        <div className="space-y-6 mt-4">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="bg-green-400/10 text-green-500 border-blue-500/30">
                4-week rollout
              </Badge>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-3">
              {["LinkedIn Campaign Manager", "Google Ads", "Salesforce"].map((tool) => (
                <div key={tool} className="flex items-center gap-2 p-2 rounded-lg bg-gray-100">
